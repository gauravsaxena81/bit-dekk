 ...
 * <p/>
 * Unlike java.util.OpenBitSet, the fact that bits are packed into an array of longs
 * is part of the interface.  This allows efficient implementation of other algorithms
 * by someone other than the author.  It also allows one to efficiently implement
 * alternate serialization or interchange formats.
 * <p/>
 * <code>OpenBitSet</code> is faster than <code>java.util.OpenBitSet</code> in most operations
 ...
 * If you want a "safe", totally encapsulated (and slower and limited) OpenBitSet
 * class, use <code>java.util.OpenBitSet</code>.
 */
...
public class OpenBitSet implements Serializable {
  ...
  /** Contructs an OpenBitSet from a OpenBitSet
  */
  public OpenBitSet(OpenBitSet bits) {
    this(bits.length());
  }
  ...
  */
  ...
  // some OpenBitSet compatability methods
